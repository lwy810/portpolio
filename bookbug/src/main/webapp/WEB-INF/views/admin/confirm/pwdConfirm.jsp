...
<script>
	$(function(){
		...
		$('#confirmMbBtn').click(function(){
				$('#login-mb-frm').attr('action','/admin/member/memberModify');
				$('#login-mb-frm').submit();
		});
	});
</script>
		...
		<div class="confirm-wrap">
			...
			<div class="confirm-container">
				...
				<div class="mb-adm-pwdconfirm-wrap">
					<c:if test = "${member == null and staff != null }">
					<form name="staff-login-frm" id="login-sa-frm" action="" method="get">
						<div class="mb-adm-member mb-adm-pwdconfirm" >
							...
							<div class="confirmSaBtn-wrap">
								<button type="submit"  id="confirmSaBtn" class="btn btn-register">확인</button>
					...
					<c:if test = "${member != null and staff == null }">
					<form name="member-login-frm" id="login-mb-frm" action="" method="get">
