...
<link rel="stylesheet" href="/resources/css/admin/mylibrary/borrow_current_list.css">
<script>	
	$(function(){
		...
		<div class="mylibrary-container">
			...
			<div class="mylibrary-wrap">
				...
				<ul class="mylibrary-menu-container">
					<li class="borrow_btn"><a href="/admin/member/mylibrary/borrow_current_list?num=1&member_id=${member.member_id }" >대출 현황</a></li>
					<li class="reservation_btn"><a href="/admin/member/mylibrary/reservation_book_list?num=1&member_id=${member.member_id }" >예약 현황</a></li>
					<li class="borrow_btn2"><a href="/admin/member/mylibrary/borrow_list?num=1&member_id=${member.member_id }" >대출 이력</a></li>
				</ul>
				...
				<div class="mylibrary-borrow-wrap">
					<c:if test="${ empty borrow_current_list }">
					<p class="null_list_msg">대출한 도서가 없습니다.</p>
					</c:if>
				
					<c:if test="${ !empty borrow_current_list }">
					<c:forEach items="${borrow_current_list}"  var="borrow_current_list" varStatus="status">
					<div class="borrow-list-container borrow-list-container-${status.index}">
						...
						<div class="book-thumbnail">
							<a href=""><img src="/libraryUploadImg/${borrow_current_list.book_thumbnail}"></a>
						</div>
					
						<ul class="borrow-list">
							<li><p>도서명 : ${borrow_current_list.book_title}</p></li>
							<li><p>자료실 위치 : ${borrow_current_list.book_position}</p></li>
							<li><p><span>대출일 : ${borrow_current_list.borrow_start}</span><span> | </span><span>반납 예정일: ${borrow_current_list.borrow_end}</span></p></li>
							<li><p>대출 상태 : ${borrow_current_list.borrow_state}</p></li>
						</ul>
					</div>
					</c:forEach>
					</c:if>
