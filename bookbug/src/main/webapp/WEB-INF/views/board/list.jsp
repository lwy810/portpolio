	...
	<section>
		<div class="bd-list-container">
			...
			<div class="bd-search-wrap">
				...
				<c:if test="${!empty list}">${page.count } 건 </c:if>
				<c:if test="${empty list}">0 건</c:if>
				</p>
			</div>	
			...
			<c:forEach items="${list}" var="bvo">
				<tr>
					...
					<td><a href="/board/view?article_num=${bvo.article_num}&num=${page.num}&article_writer=${bvo.article_writer}">${bvo.article_title}
					...
					<td>
						...
						<p class="writer">${bvo.article_writer}</p>
					</td>
					<td><fmt:formatDate value="${bvo.article_reg_date}" pattern="yyyy-MM-dd"/></td>
