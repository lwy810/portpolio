...
<%@ include file="../includes/admin-header.jsp" %>
	...
	<section>
		<div class="bd-view">
			...
			<div class="profile">
				<c:if test="${bvo.article_thumbnail != null }">
				<img id="img" src="/libraryUploadImg/${bvo.article_thumbnail }">
				</c:if>
				<c:if test="${bvo.article_thumbnail == null }">
				<img id="default" src="/resources/css/admin/imgs/account.png">
				</c:if>
			</div>
			<div class="bigImg">
				<c:if test="${bvo.article_thumbnail != null }">
				<img src="/libraryUploadImg/${bvo.article_thumbnail }">
				</c:if>
				<c:if test="${bvo.article_thumbnail == null }">
				<img src="/resources/css/admin/imgs/account.png">
				</c:if>
			</div>
			<div class="bg"></div>
			...
			<ul class="reply-list">
				<li>
					...
					<div class="profile-reply">
						<c:if test="${reply.reply_thumbnail != null }">
						<img id="pr-img" src="/libraryUploadImg/${reply.reply_thumbnail }">
						</c:if>
						<c:if test="${reply.reply_thumbnail == null  and reply.reply_writer eq '최고관리자' }">
						<img id="pr-img-default" src="/libraryUploadImg/admin5.png">
						</c:if>
						<c:if test="${reply.reply_thumbnail == null and reply.reply_writer ne '최고관리자' }">
						<img id="pr-img-default" src="/resources/css/admin/imgs/account.png">
						</c:if>
					</div>
				</li>
				<li>
